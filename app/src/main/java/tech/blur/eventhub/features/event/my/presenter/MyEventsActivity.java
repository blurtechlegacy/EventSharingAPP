...
import tech.blur.eventhub.features.event.assigned.presenter.AssignedView;
import tech.blur.eventhub.features.event.full.presentation.FullEventActivity;
import tech.blur.eventhub.features.event.list.presentation.EventListPresenter;
import tech.blur.eventhub.features.event.list.presentation.EventListPresenterFactory;
import tech.blur.eventhub.features.event.list.presentation.EventListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AddEventActivity.start(MyEventsActivity.this,null);
            }
        });
